...
// Colours
const green = 0x27e33d;


// Images
const temmie_normal = 'res/emoji/temmie_1.jpeg';
const temmie_normal2 = 'res/emoji/temmie_8.jpeg';
const temmie_dead = 'res/emoji/temmie_3.jpeg';
const temmie_search = 'res/emoji/temmie_17.jpeg';
 /**
...
module.exports = function (client, options) {
	...
	function play(msg, suffix) {
        ...
        client.user.setAvatar(temmie_search);
        const embed = new Discord.RichEmbed();
        embed.setAuthor(`${musicbot.botPrefix}${musicbot.loopCmd}`, client.user.displayAvatarURL);
        embed.setDescription(`*is searching in his shop...*`);
        embed.setColor(green);
		msg.channel.send({embed}).then(response => {
			var searchstring = suffix
			if (searchstring.includes('list=')) {
				response.edit(note('note', '*is searching the Playlist in his shop...*')).then(response => {
					//Get the playlist ID.
		    ...
		    search(searchstring, opts, function(err, results) {
					...
					function playStart(videos) {
						...
						response.delete();
						msg.channel.send(`\`\`\`\nhOI!!!!!! human choose between 1 and TEM!!!\n${text}\n\`\`\``).then(imsg => {
							...
							.then(collected => {
								...
								if (mcon.includes(`cancel`)) return imsg.edit(note('note', 'Okay.. I\'m going to put away all this stuff.'));
